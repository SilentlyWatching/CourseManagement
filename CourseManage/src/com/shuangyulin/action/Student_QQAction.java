...
/*图片字段studentPhoto参数接收*/
    ...
    public String AddStudent_QQ() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("Student_QQ添加成功!"));
            return "add_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("Student_QQ添加失败!"));
            return "error";
        }
    }
    ...
    public String ModifyStudent_QQQuery() {
        ActionContext ctx = ActionContext.getContext();
        /*根据主键studentNumber获取Student_QQ对象*/
    ...
    public String ModifyStudent_QQ() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("Student_QQ信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("Student_QQ信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteStudent_QQ() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("Student_QQ删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("Student_QQ删除失败!"));
            return "error";
        }
    }
